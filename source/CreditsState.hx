...

{
...

	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
            ...
            ['Remy', 'Remy', 'Directors of The Mods', 'https://youtube.com/@ThisIsCatzBoy', 'FFFFFF'],

            ['Beeb', 'Beeb', 'Artist And Co-Directors', 'https://youtube.com/@beeb8394', '0000FF'],

            ['Naran', 'Naran', 'Composer And Charters', 'https://youtube.com/@LowingNaran', '808080'],
