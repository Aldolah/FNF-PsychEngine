...

{
...

	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
            ...
            ['Les Copaque X FNF Crews'],

            ['Remylol', 'Remy', 'Directors of The Mods', 'https://youtube.com/@ThisIsCatzBoy', '808080'],

            ['NaranBro', 'Naran', 'Composer And Charters', 'https://youtube.com/@LowingNaran', '2C3539'],

            ['Beebers', 'Beeb', 'Artist', 'https://youtube.com/@beeb8394', 'FF0000'],

            ['NopalLah', 'Nopal', 'Composer', 'https://youtube.com/@Nopaleditz_24', '57FEFF'],

            ['EX-CODERS OF Les Copaque X FNF'],

            ['AldoKull', 'Aldo', 'Coders And A COOL GUYS IN THE WORLD', 'https://youtube.com/@AldoKullDekFNF', '00008B'],
